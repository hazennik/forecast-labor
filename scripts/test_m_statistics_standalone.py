...
spec = importlib.util.spec_from_file_location(
    "m_statistics", os.path.join(project_root, "seasonal/diagnostics/m_statistics.py")
)
...
def test_irregular_sensitivity():
    ...
    components2["original"] = (
        components2["seasonal"] + components2["trend"] + components2["irregular"]
    )
