...
GOLDEN_DIAGNOSTICS_FILE = (
    project_root / "tests" / "fixtures" / "golden_baselines" / "golden_seasonal_diagnostics.json"
)
...
PLACEHOLDER_Q_STATS = {"Q": 0.85, "p_value": 0.42}  # < 1.0 is acceptable  # > 0.05 is good
...
def create_test_diagnostics():
    ...
    series_config = {
        "CES0000000001": {"name": "Total Nonfarm Payrolls", "source": "bls_ces"},
        "CES0500000003": {"name": "Total Private Employment", "source": "bls_ces"},
        "CES4200000001": {"name": "Retail Trade Employment", "source": "bls_ces"},
        "CES7000000001": {"name": "Leisure and Hospitality Employment", "source": "bls_ces"},
    }
