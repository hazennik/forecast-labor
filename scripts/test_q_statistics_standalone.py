...
spec = importlib.util.spec_from_file_location(
    "q_statistics",
    os.path.join(project_root, "seasonal/diagnostics/q_statistics.py")
)
...
def test_random_residuals_pass():
    ...
    if result['p_value'] > 0.05:
        print(f"  ✓ Test passed: p-value > 0.05 (residuals are random)")
    else:
...
def test_autocorrelated_residuals_fail():
    ...
    print(f"  ✓ Test passed: p-value < 0.05 (autocorrelation detected)")
    print("✓ Test 3 passed\n")
