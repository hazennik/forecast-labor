...
class TestTreasuryETL:
            ...
            "data": [
                {
                    ...
                    "close_today_bal": 12000000,
                },
                {
                    "record_date": "2024-01-03",
                    "account": "Federal Taxes Withheld",
                    "close_today_bal": 11500000,
                },
                {
                    "record_date": "2024-01-04",
                    "account": "Federal Taxes Withheld",
                    "close_today_bal": 13000000,
                },
            ]
        }
    ...
    def test_treasury_extract(self, mock_download, temp_paths, mock_treasury_data):
        ...
        etl = TreasuryWithholdingsETL(
            raw_data_path=temp_paths["raw_data"], vintage_path=temp_paths["vintage"]
        )
...
class TestCESETL:
    ...
    def test_ces_extract(self, mock_post, temp_paths, mock_ces_data):
        ...
        etl = CESETL(raw_data_path=temp_paths["raw_data"], vintage_path=temp_paths["vintage"])
...
class TestLAUSETL:
    ...
    def test_laus_extract(self, mock_post, temp_paths, mock_laus_data):
        ...
        etl = LAUSETL(raw_data_path=temp_paths["raw_data"], vintage_path=temp_paths["vintage"])
...
"""
    ...
    def test_strikes_extract(self, mock_download, temp_paths, mock_strikes_csv):
        ...
        etl = StrikesETL(raw_data_path=temp_paths["raw_data"], vintage_path=temp_paths["vintage"])
...
"""
    ...
    def test_weather_extract(self, temp_paths, mock_weather_csv):
        ...
        etl = WeatherETL(raw_data_path=temp_paths["raw_data"], vintage_path=temp_paths["vintage"])
...
class TestCNBFSETL:
    ...
    def test_cnbfs_extract(self, mock_get, temp_paths, mock_cnbfs_data):
        ...
        class MockResponse:
            ...
            def json(self):
                rows = [["cell_value", "data_type_code", "time_slot_id", "time", "category_code"]]
                rows.extend(
        ...
        etl = CNBFSETL(raw_data_path=temp_paths["raw_data"], vintage_path=temp_paths["vintage"])
...
class TestAllETLPipelinesCommon:
    ...
    def test_etl_initialization(self, etl_class, module):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            etl = cls(raw_data_path=tmppath / "raw", vintage_path=tmppath / "vintages")
