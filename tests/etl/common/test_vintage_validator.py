...
class TestVintageValidation:
    ...
    def test_is_synthetic_data_function(self, synthetic_data, production_data, data_without_metadata):
...
class TestEdgeCases:
    ...
    def test_empty_dataframe(self):
        ...
        validate_vintage_is_production(
            df,
            Path("data/vintages/test/2024-11-16/empty.parquet"),
            strict=False
        )
    ...
    def test_mixed_metadata(self):
        ...
        validate_vintage_is_production(
            df,
            Path("data/vintages/test/2024-11-16/partial_meta.parquet"),
            strict=True
        )
