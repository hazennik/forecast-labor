...
class TestMinTOptimality:
    ...
    def test_projection_matrix_properties(self):
        ...
        try:
            ...
            assert np.allclose(
                agg_reconciled, agg_from_bottom, atol=1e-6
...
class TestMethodDifferences:
    ...
    def test_wls_vs_mint_different_results(self):
        ...
        n_obs = 40
        cov_matrix = np.array([[100, 30, 25, 20], [30, 25, 10, 8], [25, 10, 20, 7], [20, 8, 7, 15]])
    ...
    def test_all_four_methods_produce_different_results(self):
        ...
        n_obs = 50
        cov_matrix = np.array(
            [[120, 40, 35, 30], [40, 40, 18, 15], [35, 18, 30, 12], [30, 15, 12, 25]]
        )
...
class TestReferenceValidation:
    ...
    def test_simple_case_with_known_solution(self):
        ...
        base_forecasts = pd.DataFrame({"total": noisy_agg, "s1": noisy_s1, "s2": noisy_s2})
