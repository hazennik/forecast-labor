...
class TestMIDASRegression:
    ...
    def fitted_model(self, sample_data):
        ...
        X, y = sample_data
        model = MIDASRegression(n_lags=20, almon_degree=2, horizon=1, random_state=42)
    ...
    def test_init_custom_parameters(self):
        ...
        model = MIDASRegression(
            n_lags=30, almon_degree=3, horizon=2, include_intercept=False, random_state=123
        )
...
class TestMIDASEdgeCases:
    ...
    def test_no_intercept(self):
        ...
        model = MIDASRegression(n_lags=10, include_intercept=False, random_state=42)
        model.fit(X, y, vintage_date="2024-11-15")
