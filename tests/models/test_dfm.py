...
class TestDFMInitialization:
    ...
    def test_initialization_with_custom_params(self):
        ...
        model = DynamicFactorModel(n_factors=3, max_iter=100, tol=1e-6, random_state=123)
...
class TestDFMFitting:
    ...
    def test_fit_convergence(self, sample_data):
        ...
        X, y = sample_data
        model = DynamicFactorModel(n_factors=2, max_iter=50, tol=1e-4, random_state=42)
...
class TestDFMReproducibility:
    ...
    def test_same_seed_produces_identical_results(self, sample_data):
        ...
        np.testing.assert_array_almost_equal(model1.loadings_, model2.loadings_, decimal=10)
...
class TestDFMGetParams:
    ...
    def test_get_params_before_fit(self):
        ...
        model = DynamicFactorModel(n_factors=3, max_iter=100, tol=1e-6, random_state=42)
...
class TestDFMSaveLoad:
    ...
    def test_load_restores_model(self, fitted_model_and_path):
        ...
        np.testing.assert_array_almost_equal(loaded_model.loadings_, original_model.loadings_)
