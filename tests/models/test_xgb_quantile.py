...
class TestXGBoostQuantilePrediction:
    ...
    def fitted_model(self):
        ...
        model = XGBoostQuantile(quantiles=[0.1, 0.5, 0.9], n_estimators=10, random_state=42)
        model.fit(X, y, vintage_date="2024-11-15")
    ...
    def test_predict_quantile_ordering_without_crossing_prevention(self):
        ...
        model = XGBoostQuantile(
            quantiles=[0.1, 0.5, 0.9], n_estimators=20, prevent_crossing=False, random_state=42
        )
        model.fit(X, y, vintage_date="2024-11-15")
...
class TestFeatureImportance:
    ...
    def fitted_model(self):
        ...
        model = XGBoostQuantile(quantiles=[0.1, 0.5, 0.9], n_estimators=20, random_state=42)
        model.fit(X, y, vintage_date="2024-11-15")
...
class TestReproducibility:
    ...
    def test_same_seed_produces_identical_predictions(self):
        ...
        model1 = XGBoostQuantile(quantiles=[0.1, 0.5, 0.9], n_estimators=10, random_state=42)
        model1.fit(X, y, vintage_date="2024-11-15")
        predictions1 = model1.predict(X)

        model2 = XGBoostQuantile(quantiles=[0.1, 0.5, 0.9], n_estimators=10, random_state=42)
    ...
    def test_different_seed_produces_different_predictions(self):
        ...
        model1 = XGBoostQuantile(quantiles=[0.5], n_estimators=10, random_state=42)
        model1.fit(X, y, vintage_date="2024-11-15")
        predictions1 = model1.predict(X)

        model2 = XGBoostQuantile(quantiles=[0.5], n_estimators=10, random_state=123)
        model2.fit(X, y, vintage_date="2024-11-15")
        predictions2 = model2.predict(X)
...
class TestGetParams:
    ...
    def test_get_params_unfitted(self):
        ...
        model = XGBoostQuantile(quantiles=[0.1, 0.5, 0.9], n_estimators=50, random_state=42)
...
class TestPredictionIntervals:
    ...
    def test_get_prediction_intervals_90_percent(self):
        ...
        model = XGBoostQuantile(quantiles=[0.05, 0.5, 0.95], n_estimators=20, random_state=42)
        model.fit(X, y, vintage_date="2024-11-15")
        predictions = model.predict(X)
    ...
    def test_get_prediction_intervals_missing_quantiles(self):
        ...
        model = XGBoostQuantile(
            quantiles=[0.5], n_estimators=10, random_state=42  # Only median, no tails
        )
        model.fit(X, y, vintage_date="2024-11-15")
        predictions = model.predict(X)
