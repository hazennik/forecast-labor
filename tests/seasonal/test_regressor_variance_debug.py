...
class TestHolidayRegressorVariance:
    ...
    def test_easter_regressor_has_expected_variance_pattern(self):
        ...
        assert len(unique_values) > 1, (
            f"Easter timing should have multiple values (-1, 0, 1). "
    ...
    def test_labor_day_regressor_has_expected_variance_pattern(self):
        ...
        assert len(unique_values) > 1, (
            f"Labor Day timing should vary. Found only: {unique_values}"
        )
...
class TestRegressorPipelineFlow:
    ...
    def test_pipeline_preserves_regressor_variance(self):
        ...
        regressors = pipeline._build_regressors(
            ...
            config={"use_holiday_regressors": True, "use_strike_regressors": False, "use_weather_regressors": False}
        )
...
class TestRegressorActualValues:
    ...
    def test_easter_2020_timing_is_correct(self):
        ...
        april_value = regressors.loc[regressors.index.to_period('M') == april_2020, "easter_timing"].iloc[0]
    ...
    def test_easter_2024_timing_is_correct(self):
        ...
        march_value = regressors.loc[regressors.index.to_period('M') == march_2024, "easter_timing"].iloc[0]
        
        # Easter March 31 = late in month → expect 1
        assert march_value == 1, (
    ...
    def test_thanksgiving_2023_timing_is_correct(self):
        ...
        nov_value = regressors.loc[regressors.index.to_period('M') == nov_2023, "thanksgiving_timing"].iloc[0]
    ...
    def test_labor_day_2023_timing_is_correct(self):
        ...
        sept_value = regressors.loc[regressors.index.to_period('M') == sept_2023, "labor_day_timing"].iloc[0]
