...
class TestSpecBuilder:
    ...
    def test_build_basic_spec(self):
        ...
        config = X13Spec(series_name="TEST001", title="Test Series", start_year=2010, start_month=1)
...
class TestStrikeRegressors:
    ...
    def test_strike_impact_calculation(self):
        ...
        result = builder.build(start_date=date(2020, 1, 1), end_date=date(2022, 12, 31))
...
class TestSeasonalPipelineIntegration:
    ...
    def test_complete_seasonal_workflow_mock(self, sample_series):
        ...
        mock_output = {
            ...
            "diagnostics": {"m1": 0.15, "m2": 0.20, "q": 0.42},
        }
