...
class TestValidateCoherence:
    ...
    def test_validate_coherence_perfect_coherence(self):
        ...
        is_coherent = validate_coherence(
            forecasts, total_col="national", component_cols=["CA", "TX", "NY"], tolerance=1e-10
        )
    ...
    def test_validate_coherence_within_tolerance(self):
        ...
        is_coherent = validate_coherence(
            forecasts, total_col="national", component_cols=["CA", "TX", "NY"], tolerance=1e-6
        )
    ...
    def test_validate_coherence_two_components(self):
        ...
        forecasts = pd.DataFrame(
            {"total": [200, 205, 210], "component1": [120, 123, 126], "component2": [80, 82, 84]}
        )
    ...
    def test_validate_coherence_many_components(self):
        ...
        state_df = pd.DataFrame(state_data, columns=[f"state_{i}" for i in range(n_states)])

        # National is exact sum
        forecasts = pd.DataFrame({"national": state_df.sum(axis=1)})
...
class TestComputeCoherenceErrors:
    ...
    def test_compute_coherence_errors_zero_error(self):
        ...
        errors = compute_coherence_errors(
            forecasts, total_col="national", component_cols=["CA", "TX", "NY"]
        )
    ...
    def test_compute_coherence_errors_single_observation(self):
        ...
        forecasts = pd.DataFrame(
            {"national": [300], "CA": [100], "TX": [100], "NY": [95]}  # Sum = 295
        )
    ...
    def test_compute_coherence_errors_returns_series(self):
        ...
        forecasts = pd.DataFrame(
            {"national": [300, 305], "CA": [100, 102], "TX": [100, 101], "NY": [100, 102]}
        )
    ...
    def test_compute_coherence_errors_magnitude(self):
        ...
        errors = compute_coherence_errors(
            forecasts, total_col="national", component_cols=["A", "B", "C"]
        )
...
class TestReconciliationErrorBounds:
    ...
    def test_error_bounds_after_reconciliation(self):
        ...
        errors_before = compute_coherence_errors(
            base_forecasts, total_col="national", component_cols=["CA", "TX", "NY"]
        )
        ...
        errors_after = compute_coherence_errors(
            reconciled_forecasts, total_col="national", component_cols=["CA", "TX", "NY"]
        )
    ...
    def test_error_bounds_sector_aggregation(self):
        ...
        errors = compute_coherence_errors(
            forecasts, total_col="total_nonfarm", component_cols=sectors
        )
    ...
    def test_error_bounds_large_scale_hierarchy(self):
        ...
        errors = compute_coherence_errors(
            forecasts, total_col="national", component_cols=[f"state_{i}" for i in range(n_states)]
        )
...
class TestIntegration:
    ...
    def test_full_coherence_validation_workflow(self):
        ...
        is_coherent = validate_coherence(forecasts, "national", ["CA", "TX", "NY"], tolerance=1e-6)
        assert not is_coherent

        # 3. Compute errors
        errors = compute_coherence_errors(forecasts, "national", ["CA", "TX", "NY"])
        ...
        is_coherent_after = validate_coherence(
            reconciled, "national", ["CA", "TX", "NY"], tolerance=1e-6
        )
        assert is_coherent_after

        # 6. Verify errors are zero
        errors_after = compute_coherence_errors(reconciled, "national", ["CA", "TX", "NY"])
    ...
    def test_coherence_validation_with_summing_matrix(self):
        ...
        y_bottom = np.array(
            [[100, 100, 100], [102, 101, 102], [104, 103, 103]]  # t=0  # t=1  # t=2
        )
        ...
        is_coherent = validate_coherence(forecasts, "national", ["CA", "TX", "NY"], tolerance=1e-10)
        assert is_coherent
    ...
    def test_realistic_nfp_forecasting_scenario(self):
        ...
        # Validate coherence
        is_coherent = validate_coherence(
            forecasts, "us_total", states, tolerance=0.1  # Allow 100 jobs tolerance (0.1 thousand)
        )
