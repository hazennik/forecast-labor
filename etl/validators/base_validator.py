...
class ValidationResult:
    ...
    def is_blocking(self) -> bool:
        ...
        return (
            self.severity == ValidationSeverity.CRITICAL and self.status == ValidationStatus.FAILED
        )
...
def check_required_columns(
    df: pd.DataFrame, required_columns: List[str], rule_name: str = "required_columns"
) -> ValidationResult:
...
def check_no_nulls(
    df: pd.DataFrame, columns: List[str], rule_name: str = "no_nulls"
) -> ValidationResult:
...
def check_unique_key(
    df: pd.DataFrame, key_columns: List[str], rule_name: str = "unique_key"
) -> ValidationResult:
