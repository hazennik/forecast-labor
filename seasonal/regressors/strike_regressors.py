...
class StrikeRegressors(RegressorBuilder):
    ...
    def build(
        ...
        regressors["strike_impact"] = self._build_impact_regressor(
            dates, major_strikes
        )
    ...
    def _load_strikes_data(
        ...
        try:
            ...
            strikes_df = self.storage_client.read_parquet(
                "vintages/strikes/latest/strikes.parquet"
            )
