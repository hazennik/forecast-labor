...
class BaseForecaster(ABC):
    ...
    @abstractmethod
    def fit(self, X: pd.DataFrame, y: pd.Series, vintage_date: str) -> "BaseForecaster":
        """
    ...
    def save(self, path: Path) -> None:
        ...
        Example:
            ...
            ```
        """
        raise NotImplementedError(f"{self.__class__.__name__} must implement save() method")
    ...
    def load(cls, path: Path) -> "BaseForecaster":
        ...
        Example:
            ...
            ```
        """
        raise NotImplementedError(f"{cls.__name__} must implement load() class method")
