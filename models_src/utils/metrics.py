...
def _validate_arrays(
    y_true: Union[np.ndarray, list], y_pred: Union[np.ndarray, list], name: str = "metric"
...
def expected_calibration_error(
    y_true: Union[np.ndarray, list], y_pred_probs: Union[np.ndarray, list], n_bins: int = 10
) -> float:
    """
...
def mape(
    y_true: Union[np.ndarray, list], y_pred: Union[np.ndarray, list], epsilon: float = 1e-10
) -> float:
    """
...
def compute_metrics(y_true: Union[np.ndarray, list], y_pred: Union[np.ndarray, list]) -> dict:
    """
